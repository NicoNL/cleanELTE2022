...
sumOfEvenDigitsMinusSumOfOddDigits a
| ( a / 10) == 0 && (a rem 2) == 1 = a * -1
| ( a / 10) == 0 && (a rem 2) == 0 = a
| ( a rem 10) == 0 = (a rem 10) + (sumOfEvenDigitsMinusSumOfOddDigits (a /10))
| ( a rem 10) rem 2 == 0 && a > 10 = ((a rem 10) + sumOfEvenDigitsMinusSumOfOddDigits (a /10))
| ( a rem 10) rem 2 == 1 && a > 10 = (((a rem 10) * -1) + sumOfEvenDigitsMinusSumOfOddDigits (a /10))

//Start = sumOfEvenDigitsMinusSumOfOddDigits 123
...
largestDigit n
| n < 10 = n
| n > 10 && (n rem 10) >= (largestDigit( n / 10)) = n rem 10
| n > 10 && (n rem 10) <= (largestDigit( n / 10)) = largestDigit( n / 10)

Start = largestDigit 7079
...
task3 a ch
| a < 10 = a
| a > 10 && ch == 's' = a rem 10 + task3 (a/10) 's'
| a > 10 && ch == 'm' = (a rem 10) * task3 (a/10) 'm'
